...
func NewUserSource(client *iam.Client, accountID string, region string) *adapters.GetListSource[*UserDetails, IAMClient, *iam.Options] {
	return &adapters.GetListSource[*UserDetails, IAMClient, *iam.Options]{
		ItemType:        "iam-user",
		Client:          client,
		AccountID:       accountID,
