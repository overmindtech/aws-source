...
func NewOriginRequestPolicySource(client *cloudfront.Client, accountID string) *adapters.GetListSource[*types.OriginRequestPolicy, *cloudfront.Client, *cloudfront.Options] {
	return &adapters.GetListSource[*types.OriginRequestPolicy, *cloudfront.Client, *cloudfront.Options]{
