...
func (m mockDataProtectionPolicyClient) GetDataProtectionPolicy(ctx context.Context, params *sns.GetDataProtectionPolicyInput, optFns ...func(*sns.Options)) (*sns.GetDataProtectionPolicyOutput, error) {
	return &sns.GetDataProtectionPolicyOutput{
		DataProtectionPolicy: adapters.PtrString("{\"Name\":\"data_protection_policy\",\"Description\":\"Example data protection policy\",\"Version\":\"2021-06-01\",\"Statement\":[{\"DataDirection\":\"Inbound\",\"Principal\":[\"*\"],\"DataIdentifier\":[\"arn:aws:dataprotection::aws:data-identifier/CreditCardNumber\"],\"Operation\":{\"Deny\":{}}}]}"),
	}, nil
}
...
func TestGetDataProtectionPolicyFunc(t *testing.T) {
	...
	item, err := getDataProtectionPolicyFunc(ctx, cli, "scope", &sns.GetDataProtectionPolicyInput{
		ResourceArn: adapters.PtrString("arn:aws:sns:us-east-1:123456789012:mytopic"),
	})
	if err != nil {
		t.Fatal(err)
	}
