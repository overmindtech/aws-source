		...
		DirectConnectGatewayAssociations: []types.DirectConnectGatewayAssociation{
			{
				...
				AssociationId:              adapters.PtrString("cf68415c-f4ae-48f2-87a7-3b52cexample"),
				VirtualGatewayOwnerAccount: adapters.PtrString("123456789012"),
				DirectConnectGatewayId:     adapters.PtrString("5f294f92-bafb-4011-916d-9b0bexample"),
				VirtualGatewayId:           adapters.PtrString("vgw-6efe725e"),
			},
		},
	}
		...
		DirectConnectGatewayAssociations: []types.DirectConnectGatewayAssociation{
			{
				...
				DirectConnectGatewayId:     adapters.PtrString("5f294f92-bafb-4011-916d-9b0bexample"),
				VirtualGatewayId:           adapters.PtrString("vgw-6efe725e"),
				StateChangeError:           adapters.PtrString("something went wrong"),
			},
		},
	}
